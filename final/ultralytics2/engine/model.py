...
from ultralytics2.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics2.engine.results import Results
from ultralytics2.hub.utils import HUB_WEB_ROOT
from ultralytics2.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics2.hub.session import HUBTrainingSession
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        from ultralytics2 import __version__
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics2.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics2.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics2.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from ultralytics2.nn.autobackend import check_class_names
